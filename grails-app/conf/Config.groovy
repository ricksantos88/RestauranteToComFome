...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'core.Usuario'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'core.UsuarioPermissao'
grails.plugin.springsecurity.authority.className = 'core.Permissao'
